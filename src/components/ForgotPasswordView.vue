    ...
    <el-container class="forgot-password-container">
      <el-main class="forgot-password-main">
        ...
        <el-form @submit.prevent="resetPassword" class="forgot-password-form animate__animated animate__zoomIn">
          ...
          <el-form-item>
            <el-button type="primary" @click="resetPassword" round block class="animate-pulse">重置密码</el-button>
          </el-form-item>
          <el-form-item>
            <el-button type="text" @click="goToLogin" round block>记得密码? 登录</el-button>
          </el-form-item>
        </el-form>
      </el-main>
    </el-container>
